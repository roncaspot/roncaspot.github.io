...
import {
    ...
    SoftSkills,
    skills,
} from "@this/src/modules/roncaspot/data/curriculum/skills";
...
var Languages = Skills.Linguistic.MotherTongue.concat(
    Skills.Linguistic.ForeignLanguage
);
...
export default (props) => {
    ...
    const loadWorkExperiences = async () => {
        const experiences = await WorkExperiences();
    ...
    return (
        <div style={{ display: !display ? "none" : "block" }}>
            <div ref={props.innerRef}>
                ...
                <section
                    id="about"
                    className={!toPrint ? "section wow fadeInUpBig" : ""}
                >
                            ...
                            <div className="col-sm-9">
                                <div className="about-info row">
                                    ...
                                    <div className="col-sm-12 social-profiles">
                                        ...
                                        {Identification.ContactInfo.Website.map(
                                            (value, key) => {
                                                return (
                                                    <>
                                                        {toPrint && <br />}
                ...
                <section
                    id="skills"
                    className={!toPrint ? "section wow fadeInUp" : ""}
                >
                    <div className="container-section">
                        <div className="row">
                            <div className="section-title">
                                <h4>Skills</h4>
                                <h5>
                                    <b>Skill formula:</b> (1 - tanh(expYear /
                                    expDecay)) * avg(proficiencyPerc,
                                    interestPerc)
                                </h5>
                            </div>
                        </div>
                        <div className="row">
                            {skills.mainSkills.map((main, key) => {
                                ...
                                main.list.forEach((skill) => {
                                    skill.lastYear =
                                        skill.lastYear > skill.firstYear
                                            ? skill.lastYear
                                            : currentYear;
                                    let expYears =
                                        skill.lastYear - skill.firstYear;
                                    ...
                                    let expMul = expDecay
                                        ? 1 - Math.tanh(expYears / expDecay)
                                        : 1;
                                    skill.expValue =
                                        (expMul + 1) *
                                        ((skill.proficiency + skill.interest) /
                                            2);
                                ...
                                main.list.forEach((skill) => {
                                    skill.expPercentage = Math.round(
                                        (skill.expValue / maxExp) * 100
                                    );
                                });
                                            ...
                                            {chunk(main.list, 6).map((row) => {
                                                return (
                                                    <div className="skill">
                                                        {row.map(
                                                            (skill, key2) => (
                                                                <div className="col-sm-6 skill-bar">
                                            ...
                                            {row.map((value, key) => (
                                                ...
                                                >
                                                    <div className="service-box">
                                                        <span className="service-icon pull-left">
                                                            <i
                                                                className={
                                                                    value.icon
                                                                }
                                        ...
                                        {Languages.map((value, key) => {
                                            return (
                                                <div className="col-sm-3">
                                                    ...
                                                    <div
                                                        className="percentage easyPieChart"
                                                        data-percent={
                                                            value.Description
                                                                .__hwc_value
                                                        }
                                                        data-animate={toPrint}
                                                        data-delay={100}
                                                    >
                                                        <span>
                                                            {
                ...
                >
                    <div className="container-section">
                        ...
                        <div className="resume-section education">
                            <div
                                className={!toPrint ? "timeline-container" : ""}
                            >
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="timeline-description"><p
                                                    style={{
                                                        fontWeight: "bold",
                                                    }}
                                                >
                                                    Role: {value.Position.Label}
                                                </p>
                                                <ReactMarkdown
                                                    rehypePlugins={[rehypeRaw]}
                                                    linkTarget="_blank"
                                                    children={value.Activities}
                                                />
                                                </div>
                                            </div>
                                        </div>
                ...
                <section
                    ...
                    className={"section" + (!toPrint ? " wow fadeInUp" : "")}
                >
                    <div className="container-section">
                        <div className="row">
                            <div className="section-title">
